 ...
 *  This is a plain const (not env) so it's safe to read from the client bundle —
 *  the retrieval call runs in the browser. See [[project_recall_pivot_expert_field_view]]. */
export const RETRIEVAL_V2_ENABLED = false;
