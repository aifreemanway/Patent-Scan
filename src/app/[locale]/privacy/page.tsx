      ...
      <main className="flex flex-1 justify-center px-6 py-12">
        <article className="w-full max-w-3xl space-y-6 text-slate-800">
          ...
          <Section title="5. Где хранятся данные">
            <p>
              Все ваши персональные данные (email, аккаунт, история запросов)
              размещены на серверах в Российской Федерации (Timeweb, Москва).
            </p>
            <p>
              Аутентификация по ссылке или коду подтверждения реализована
              собственным сервисом — на внешние SaaS-провайдеры аккаунты не
              передаются.
            </p>
            <p>
              Для AI-анализа описаний изобретений используется языковая модель:
              на её сторону передаётся{" "}
              <strong>только обезличенный технический текст описания</strong>, без
              email, имени или иных идентификаторов пользователя. Это не
              персональные данные по смыслу ст. 3 ч. 1 152-ФЗ.
            </p>
            <p>
              Запросы конфиденциальны: не индексируются и не передаются третьим
              лицам.
            </p>
          </Section>
          ...
          <Section title="7. Транзакционные письма (без отдельного согласия)">
            ...
            <ul className="ml-5 mt-2 list-disc space-y-1">
              <li>Ссылка или код подтверждения для входа / регистрации.</li>
              <li>
          ...
          <Section title="9. Права субъекта персональных данных">
            ...
            <ul className="ml-5 mt-2 list-disc space-y-1">
              ...
              <li>
                отозвать согласие на обработку данных, необходимых для работы
                аккаунта (влечёт удаление аккаунта);
              </li>
              <li>
                отозвать отдельные согласия — на информационные рассылки и на
                звонок — без удаления аккаунта;
              </li>
