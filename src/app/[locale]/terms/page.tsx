    ...
    <>
      ...
      <main className="flex flex-1 justify-center px-6 py-12">
        <article className="w-full max-w-3xl space-y-6 text-slate-800">
          ...
          <Section title="4.1. Требования к адресу электронной почты">
            <p>
              Доступ к Сервису предоставляется по ссылке или коду
              подтверждения, направляемым на указанный Пользователем адрес
              электронной почты. Указанный адрес
              используется как средство идентификации Пользователя и как адрес
              для направления юридически значимых сообщений (статья 165.1
              Гражданского кодекса Российской Федерации).
            </p>
            <p className="mt-2">
              Пользователь обязуется указать действующий адрес, к которому имеет
              постоянный доступ, и поддерживать его в актуальном состоянии.
              Сообщения, направленные Оператором по указанному адресу, считаются
              доставленными, в том числе если они не были вручены по
              обстоятельствам, зависящим от Пользователя.
            </p>
            <p className="mt-2">
              Оператор вправе отказать в регистрации или прекратить доступ к
              учётной записи, созданной с использованием адреса сервиса
              одноразовой (самоуничтожающейся) электронной почты либо адреса,
              недоступного для доставки почты. Такое ограничение носит
              технический характер, применяется единообразно ко всем
              Пользователям и не связано с личностью обратившегося.
            </p>
            <p className="mt-2">
              Пользователь вправе обратиться в поддержку по адресу
              support@patent-scan.com. При подтверждении работоспособности
              адреса регистрация открывается.
            </p>
          </Section>
