...
Целься в 3-5 таблиц, разрезающих тему с разных сторон (3-7 строк в каждой). Подбирай ось сравнения и набор разрезов под конкретный topic — НЕ привязывайся к одному шаблону.
