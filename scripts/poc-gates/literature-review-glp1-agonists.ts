// Sample literature review: GLP-1 agonists (semaglutide, tirzepatide).
...
const PARAMS: LitReviewParams = {
  topic:
    "GLP-1 агонисты (семаглутид, тирзепатид, лираглутид) для лечения сахарного диабета 2 типа и ожирения: мировые производители (Novo Nordisk, Eli Lilly), биосимиляры и дженерики в РФ и Китае, патентный пейзаж, регуляторные пути 2020-2026.",
  industry: "biotech",
  regions: ["RU", "CIS", "CN", "US", "EU", "WORLD"],
  periodFrom: 2020,
  periodTo: 2026,
  hypotheses:
    "Гипотеза: рынок GLP-1 — фактическая дуополия Novo Nordisk / Eli Lilly с выручкой $30+ млрд (2024); патент на семаглутид истекает в США в 2032 (Россия 2026); китайские (Hengrui, Innovent) и индийские (Sun, Cipla) игроки готовят биосимиляры; в РФ — пилотные дженерики (Геропрфарм). Хочу оценить патентный обрыв, конкурентов в РФ-сегменте и регуляторные пути.",
};

const SLUG = "glp1-agonists";
